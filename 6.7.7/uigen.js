        ...
        var callDrawLoop = function(
            ...
            const drawOnce = () => {
                ...
                try {
                    ...
                    console.log(el_item);
                    console.log(publishToPlaceKind);
                    ...
                    switch (publishToPlaceKind) {
                    case '1':
                        //el_item.replaceWith(newElement);
                    ...
                    console.log( document.getElementById(naviItem["embed_id"]) );  
                    ...
                    if (el) el.setAttribute('data-navi-rendered', '1');
                } catch (e) {
                    console.error('💥 Lỗi khi draw:', e);
                }
            };

            // Gọi ngay 1 phát đầu (để không phải chờ tick đầu)
            drawOnce();
            ...
            const timer = setInterval(() => {
                ...
                // Nếu container có mà bị “đè” (mất cờ) → vẽ lại
                if (el.getAttribute('data-navi-rendered') !== '1') {
                    console.log('⚠️ Bị đè/mất cờ, re-draw →', id);
                    drawOnce();
                    return;
                }
 ...
 *  - Hysteresis 6px để tránh rung giật.
 ...
 *  - Có thể thay đổi thời gian transition (.22s) hoặc hysteresis (6px) theo ý muốn.
 */
