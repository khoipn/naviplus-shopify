...
var isItemSMS = function ( item_url ) {
    ...
    return  false;
        ...
        response.forEach((naviItem) => {
            ...
            if( isDisplayed ) // Đã pass qua việc hiển thị theo nhóm trang thì mới kiểm tra tiếp
            {
            ...
            /***********************************************
            Thực hiện việc replace menu tại chỗ này
            ***********************************************/
            ...
            if( isPublishToPlace == true ) {
                ...
                isNaviSection = true;
                // TODO: QUAN TRỌNG LÀ CHƯA KIỂM TRA PLATFORM, KEYWORDs
                isDisplayed = true;
            }
            ...
            ***********************************************/
            ...
            if (isDisplayed) {
                ...
                var divNaviItem = '<div style="visibility: hidden;'+ embedMarginStyle +'" '+ attribute +' name="' + naviItem["name"] + '" id="'+ naviItem["embed_id"] +
                    '" class="naviItem ' + publishToPlace + naviItem["embed_id"] + menuPositionClass( data ) + ' ' + getClassOfMenuKind(navihelper.windowVar.get('shopinfo'), naviItem["embed_id"])  + '"></div>';
