...
Menu.Context.checkReplaceHambugerMenu = function(elsIdClass, newEl, callFunction) {
    ...
    if (elsIdClass.includes("#Details-menu-drawer-container")) {
        ...
        if (localStorage.getItem("__isDebug") === "true") {
            console.log("Special fix: checkReplaceHambugerMenu ");
            console.log(overlay);
            console.log(rootEl);
        }
      ...
      var elsArray = Helper.String.stringToArray(naviItem["data"]["setting"]['publishTriggerIDClass']);
        ...
        elsArray.forEach(function(elsIdClass) {
            ...
            els.forEach(function(newEl) {
                ...
                // var newEl = el; // el.cloneNode(true); // Tạo bản sao
                ...
                // el.parentNode.replaceChild(newEl, el); // Thay thế phần tử gốc bằng bản sao
